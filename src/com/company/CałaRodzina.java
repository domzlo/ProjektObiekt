...
public class CałaRodzina {
    ...
    public static void main(String[] args) {
        Osoba tata = new Osoba("Jan", "Kowalski", 90);
//        tata.imie = "Jan";
...
//        tata.waga = 90;
        ...
        Osoba mama = new Osoba("Barbara", "Kowalska", 65);
//        mama.wiek = 35;
//        mama.waga = 65;

        Osoba córka = new Osoba("Ola", "Kowalska", 40);
//        córka.imie = "Ola";
...
//        córka.waga = 40;
        ...
        Osoba syn = new Osoba("Janek", "Kowalski", 80);
//        syn.imie = "Janek";
